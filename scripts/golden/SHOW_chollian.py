...
#      ✅✅ **로켓 자세 확정 (2026-08-13 probe_rocket_hpr.py)**: 지구에서 바깥으로 세우려면
#         **`setOrientationHPR(Vec(그 물체의 경도, 90, 0))`**. 경도 8곳에 걸어 바퀴살로 확인.
#    ⚠️ **v9 에서 아직 돔에서 못 본 것**: Intro 하강(R 26→3.4) · Scene 1 이륙 고도 R=1.6 ·
#       **로켓이 상승하는 장면**(자세는 확정, 구도는 미확인) · Outro 도시 불빛 + 마지막 타블로 + 지상 복귀 ·
